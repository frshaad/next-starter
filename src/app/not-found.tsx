...
export default function NotFound() {
  ...
  return (
    <div className="from-background via-muted/10 to-muted/30 flex min-h-screen items-center justify-center bg-linear-to-br">
      <div className="max-w-lg space-y-8 p-8 text-center">
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform">
            <div className="border-primary/20 bg-primary/10 dark:bg-primary/20 flex h-16 w-16 items-center justify-center rounded-full border">
        ...
        {/* Suggestions */}
        <div className="border-border/50 bg-card/60 space-y-3 rounded-lg border p-6 backdrop-blur-sm">
